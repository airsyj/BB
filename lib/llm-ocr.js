...
async function recognize(image, kind, cfgList, opts) {
  const MAX_ATTEMPTS = (opts && opts.maxAttempts) || 4; // 控制总耗时，避免无谓兜圈
...
module.exports = { llmOcr, recognize, isValidIdNumber, isValidPlate, cleanPlate, cleanId, cleanDate, normalize, extractJson };
