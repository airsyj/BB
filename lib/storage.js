...
const { isCloudbase, uploadFile: cbUpload, getTempFileURL: cbTempUrl, getFileID } = require('./cloudbase');
...
module.exports = { isDataUrl, savePhoto, persistPhotos, readPhoto, LOCAL_UPLOADS_DIR };
